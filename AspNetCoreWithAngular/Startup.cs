...
using AspNetCoreWithAngular.ServiceLayer;
...
namespace AspNetCoreWithAngular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Data Source=.;Initial Catalog=AspNetCoreWithAngular_Db;Trusted_Connection=True;ConnectRetryCount=0";
            services.AddDbContext<AppDbContext>
                (options => options.UseSqlServer(connection, b => b.MigrationsAssembly("AspNetCoreWithAngular")));
